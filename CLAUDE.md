...
| Tab | Name | Contents |
|-----|------|----------|
| 1 | **Discover** | Filters (live/debounced; collapsed by default on mobile; studio multi-select chips) → search results → instructor discovery (New to you / You might like) |
