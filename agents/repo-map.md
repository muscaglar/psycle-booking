...
│                           #   NOT in the app shell: build.js does not copy it, sw.js does not precache it. Names the publisher and ONE contact address (22-play-release.js); support.html beside it is the stores' Support URL, the same kind of page
