...
module.exports = async function (t) {
  ...
  const CLOUD = { '--bg': '#efeee9', '--bg-panel': '#ffffff', '--border': '#e7e5df', '--text-heading': '#0e0f12', '--text-muted': '#5c5e63', '--accent': '#1f6f5c' };
  ...
  t.section('Share images: stats card');
  {
    ...
    ok(!!word && /Bricolage Grotesque/.test(word[5]) && /^700 /.test(word[5]), 'wordmark "Psync" in the display face');
